                ...
                <div class="event-card">
                  <div class="event-card-header">
                    ...
                    <div class="event-actions">
                      <button class="event-action-btn event-edit-btn" onclick="editEvent('<?php echo htmlspecialchars($event['event']['title'], ENT_QUOTES); ?>')" title="Edit event">
                        ...
                        <?php foreach ($event['staff'] as $staffMember): ?>
                          <div class="staff-card">
                            <div class="staff-photo">
                              <img src="<?php echo htmlspecialchars($staffMember['photo'] ?? '../assets/img/default-avatar.png'); ?>">
                            </div>
